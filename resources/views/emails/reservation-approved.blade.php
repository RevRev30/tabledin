...
<body style="font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif; line-height: 1.5; color: #111827;">
    <div style="max-width: 640px; margin: 0 auto; padding: 24px;">
        <h2 style="margin: 0 0 8px 0;">Your reservation needs your confirmation</h2>
        <p style="margin: 0 0 16px 0;">Hi {{ $reservation->customer->name ?? 'there' }},</p>
        <p style="margin: 0 0 16px 0;">Your reservation at <strong>{{ $reservation->restaurant->name ?? 'our restaurant' }}</strong> has been updated.</p>
